    ...
    <div className="space-y-4">
      <div className="shadow-xl rounded-3xl p-2 bg-white dark:bg-slate-800 border border-gray-100 dark:border-slate-700">
        ...
        <div className="flex space-x-1">
          ...
          <select aria-label="Cut Length Unit" value={formData.cutLengthUnit} onChange={e => setFormData({...formData, cutLengthUnit: e.target.value})} className="input-premium w-auto bg-white dark:bg-slate-700 font-bold">
      ...
      <div className="shadow-xl rounded-3xl p-2 bg-white dark:bg-slate-800 border border-gray-100 dark:border-slate-700">
        ...
        <div className="flex items-center space-x-1">
          ...
          <select aria-label="Starting Mark Unit" value={formData.startingMarkUnit} onChange={e => setFormData({...formData, startingMarkUnit: e.target.value})} className="input-premium w-auto dark:bg-slate-700 font-bold" disabled={formData.isNoMarks}>
